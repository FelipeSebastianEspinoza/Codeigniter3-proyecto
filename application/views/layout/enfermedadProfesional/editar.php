<h1>Modificar Enfermedad Profesional</h1>
    ...
    <div class="col-lg-12">
        ...
        <div class="card shadow mb-4">
            ...
            <a class="d-block card-header py-3" aria-expanded="true" aria-controls="collapseCardExample">
                <h6 class="m-0 font-weight-bold text-primary">Modificar Enfermedad Profesional</h6>
            </a>
                ...
                <div class="card-body">
                    <div>
                        ...
                        <div class="form-group row" id="nombre">
                            <input type="hidden" id="inputId" name="id_enfermedad" class="form-control form-control-user" value="<?php echo $obj->id_enfermedad ?>">
        ...
        $(document).ready(function() {
            $('#upload_form').on('submit', function(e) {
                e.preventDefault();
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "<?php echo site_url() . '/enfermedadProfesional/modificarajax_upload' ?>",
                            data: $(this).serialize(),
