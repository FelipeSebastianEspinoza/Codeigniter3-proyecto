...
<div class="col-lg-12">
    ...
    <div class="card shadow mb-4">
        ...
        <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
            <h6 class="m-0 font-weight-bold text-primary">Nuevo Extintor</h6>
        </a>
            ...
            <div class="card-body">
                <div>
                    ...
                    <div class="col-sm-3 mb-3 mb-sm-0">
                            ...
                            <input type="date" id="inputNombre" name="nombre" class="form-control form-control-user" placeholder="Escriba el nombre...">
                            <div class="invalid-feedback" id="inputNombreText">
                            </div>
                        </div>
                        <div class="col-sm-3 mb-3 mb-sm-0">
        ...
        $(document).ready(function() {
            $('#upload_form').on('submit', function(e) {
                ...
                if ($('#image_file').val() == '') {
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo site_url() . '/extintor/crearExtintorajax' ?>",
                        data: $(this).serialize(),
